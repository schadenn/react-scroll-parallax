...
exports.getParallaxStyles = getParallaxStyles;
 ...
 */
function getParallaxStyles(elInner, offsets, percentMoved) {
  ...
  return "translate3d(".concat(xv).concat(xu, ", ").concat(yv).concat(yu, ", 0)");
}
/**
